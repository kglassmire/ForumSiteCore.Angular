...
export class ForumService {
    ...
    controversial(name: string): Observable<ForumPostListingResponse | null> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ForumPostListingResponse | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ForumPostListingResponse | null>><any>_observableThrow(response_);
        }));
    }

    protected processControversial(response: HttpResponseBase): Observable<ForumPostListingResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            result200 = resultData200 ? ForumPostListingResponse.fromJS(resultData200) : <any>null;
        ...
        return _observableOf<ForumPostListingResponse | null>(<any>null);
    }

    forumSearch(search: string): Observable<ForumSearchResponse | null> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ForumSearchResponse | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ForumSearchResponse | null>><any>_observableThrow(response_);
        }));
    }

    protected processForumSearch(response: HttpResponseBase): Observable<ForumSearchResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = resultData200 ? ForumSearchResponse.fromJS(resultData200) : <any>null;
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ForumSearchResponse | null>(<any>null);
    }

    hot(name: string): Observable<ForumPostListingResponse | null> {
    ...
    protected processHot(response: HttpResponseBase): Observable<ForumPostListingResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    new(name: string): Observable<ForumPostListingResponse | null> {
    ...
    protected processNew(response: HttpResponseBase): Observable<ForumPostListingResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    top(name: string): Observable<ForumPostListingResponse | null> {
    ...
    protected processTop(response: HttpResponseBase): Observable<ForumPostListingResponse | null> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class PostService {
    ...
    save(id: number): Observable<FileResponse | null> {
...
export abstract class BaseApiResponse implements IBaseApiResponse {
    status?: string | null;
    message?: string | null;
    ...
    static fromJS(data: any): BaseApiResponse {
        data = typeof data === 'object' ? data : {};
        throw new Error("The abstract class 'BaseApiResponse' cannot be instantiated.");
    }
...
export class ForumPostListingResponse extends BaseApiResponse implements IForumPostListingResponse {
    data?: ForumPostListingVM | null;

    constructor(data?: IForumPostListingResponse) {
        super(data);
    }
    ...
    init(data?: any) {
        super.init(data);
        if (data) {
            this.data = data["data"] ? ForumPostListingVM.fromJS(data["data"]) : <any>null;
        }
    }

    static fromJS(data: any): ForumPostListingResponse {
        data = typeof data === 'object' ? data : {};
        let result = new ForumPostListingResponse();
        result.init(data);
        return result;
    }
...
export interface IForumPostListingResponse extends IBaseApiResponse {
    data?: ForumPostListingVM | null;
}
...
export class ForumSearchResponse extends BaseApiResponse implements IForumSearchResponse {
    data?: string[] | null;

    constructor(data?: IForumSearchResponse) {
        super(data);
    }
    ...
    static fromJS(data: any): ForumSearchResponse {
        data = typeof data === 'object' ? data : {};
        let result = new ForumSearchResponse();
        result.init(data);
        return result;
    }
...
export interface IForumSearchResponse extends IBaseApiResponse {
    data?: string[] | null;
}
...
export class CommentDto implements ICommentDto {
    ...
    init(data?: any) {
        if (data) {
            ...
            this.commentsCount = data["commentsCount"] !== undefined ? data["commentsCount"] : <any>null;
            this.savesCount = data["savesCount"] !== undefined ? data["savesCount"] : <any>null;
            this.bestScore = data["bestScore"] !== undefined ? data["bestScore"] : <any>null;
            this.controversyScore = data["controversyScore"] !== undefined ? data["controversyScore"] : <any>null;
            this.userName = data["userName"] !== undefined ? data["userName"] : <any>null;
            this.userVote = data["userVote"] !== undefined ? data["userVote"] : <any>null;
            this.userCreated = data["userCreated"] !== undefined ? data["userCreated"] : <any>null;
    ...
    toJSON(data?: any) {
        ...
        data["commentsCount"] = this.commentsCount !== undefined ? this.commentsCount : <any>null;
        data["savesCount"] = this.savesCount !== undefined ? this.savesCount : <any>null;
        data["bestScore"] = this.bestScore !== undefined ? this.bestScore : <any>null;
        data["controversyScore"] = this.controversyScore !== undefined ? this.controversyScore : <any>null;
        data["userName"] = this.userName !== undefined ? this.userName : <any>null;
        data["userVote"] = this.userVote !== undefined ? this.userVote : <any>null;
        data["userCreated"] = this.userCreated !== undefined ? this.userCreated : <any>null;
