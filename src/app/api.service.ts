...
export class ForumService {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ForumPostListing | null>><any>_observableThrow(e);
                }
            } else
                return <Observable<ForumPostListing | null>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processNew(response: HttpResponseBase): Observable<ForumPostListing | null> {
        ...
        return _observableOf<ForumPostListing | null>(<any>null);
    }
